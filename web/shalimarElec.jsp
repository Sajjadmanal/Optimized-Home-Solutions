...
<body>
	...
	<div class="container">
        ...
        <% 
            ...
            PreparedStatement st=conn.prepareStatement("select * from electricians where aow='103'");
            ResultSet rs=st.executeQuery();
            ResultSetMetaData rsmd=rs.getMetaData();
            int totalrows=rsmd.getColumnCount();
            //out.print(rsmd.getColumnName(13));
	...
	<div class="container">
		<div class="content">
			<div class="col-md-7 content-left">
				<div class="article">
                                    <h5 class="head">Welcome</h5>
                                    
                                    
					<h6><%out.println("Electricians Details: Shalimar Bagh");%></h6>
...
while(rs.next())
    {
				...
				%>
                                ...
                                <table style="width:100% " border="5"  cellspacing="3" cellpadding="3">
                                    <thead>
                                        <tr>
                                            <th>Electrician </th>
                                            <th></th>
